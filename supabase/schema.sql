...
-- USER PROFILES: public read (alias + verified status only — no PII stored here),
-- but only own profile can be updated
...
-- ============================================================
-- OFFICER VERIFICATION — Agency-Issued Access Codes
-- ============================================================

-- Extend user_profiles with verification status
...
-- One-time codes generated by admins and distributed by agencies to their officers
...
-- RLS: codes table is managed exclusively via service-role API routes.
-- No client-side access — all reads/writes go through server API.
